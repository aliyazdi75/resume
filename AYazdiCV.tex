...
\href{https://medium.com/@aliyazdi75}
{\underline{A. Yazdi}},
\href{https://medium.com/flutter-community/lets-make-the-flutter-navigator-2-bc5953251c3e}
{
...
{\faAndroid}
\,\SubBulletSymbol\,
\href{https://94.ceit.aut.ac.ir/gallery/}
{\faGlobe}
\,\SubBulletSymbol\,
...
The web application is hosting on the \textbf{Amirkabir University} website for Alumni students.
\SubBulletItem
Features: Sound Null-Safety, Navigator 2, Two External API providers (Server, Github),
Unique HEX URL generator for github content API, Keyboard Shortcut, Localization, Multi-Themes, Multi-Devices Adaptive Size.
...
\SubBulletItem
Features: Full Authentication service, Chat list and Chat page, Full webRTC handshaking through SignalR (Offer, Answer, Candidate, HangUp, Reject),
