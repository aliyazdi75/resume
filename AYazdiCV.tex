...
\BulletItem
Open-Source projects contributor and flutter community speaker and assistance.
\BulletItem
...
\hfill
\textsl{\small{\DatestampYM{2020}{06}\,--\,\DatestampYM{2021}{06}}}
...
\begin{Detail}
\SubBulletItem
Working on Flutter's best architecture design for the current requirements.
\SubBulletItem
...
\SubBulletItem
Supporting other Firebase services like Analytics and Crashlytics.
\SubBulletItem
...
Other
\Item
\textbf{Software Systems Engineering, Cross-Platform Application Development, Cryptocurrency}
...
\Gap
Community Leader and Speaker
\BulletItem
An organization for the Persian Flutter community.
\begin{Detail}
\SubBulletItem
Oraganizing Github and Discord server.
\hfill
{\normalsize{
