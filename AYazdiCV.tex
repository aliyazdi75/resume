...
\begin{Body}
    ...
    \begin{Detail}
        \SubBulletItem
        Upgrading the application's Flutter version and implementing new features like null-safety, new localization, and refactoring to a standard project code style with the help of analysis options.
        \SubBulletItem
        Improving the application's structure, tests and stability based on fixing Sentry issues, migrating to null-safety, reducing assets files, using icon fonts, and setting up the application for deferred components. Therefore the new bugs were reduced by 70\%, application performance was improved by dropping useless frame rendering and 20ms less rendering time in profile mode, and application size drastically decreased by 89MB.
        \SubBulletItem
        Applying automation between development tools, including Github actions, Sentry, Jira, Slack and Lokalise.
        \SubBulletItem
        Coworking on new features requested by business in an agile team with an external software organization.
    \end{Detail}
