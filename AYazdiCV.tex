...
\newcommand{\TitleDesciption}{Senior Flutter Developer at Woopen}
...
\newcommand{\SecondoryEmailName}{ma.yazdi75@aut.ac.ir}
\newcommand{\SecondoryEmail}{mailto:ma.yazdi75@aut.ac.ir}
...
\begin{Body}
    ...
    {About Me}
    {PDF:AboutMe}
    A software engineer motivated by contributing to the open-source community, developing and using  Flutter for the best performance and user experience. Passionate about artificial intelligence and software engineering methodologies.
    ...
    \begin{Detail}
        ...
        \SubBulletItem
        Improved the application's structure, tests and stability based on fixing Sentry issues, migrating to null-safety, reducing assets files, using icon fonts, and setting up the application for deferred components. Therefore the new bugs were reduced by 70\%, application performance was improved by dropping useless frame rendering and 20ms less rendering time in profile mode, and application size drastically decreased by 89MB.
        \SubBulletItem
        Set-up and applied automation between development tools, including Github actions, Sentry, Jira, Slack and Lokalise.
        \SubBulletItem
        Coworked on new features requested by the business side in an agile team with an external software organization.
    \end{Detail}
    ...
    \begin{Detail}
        \SubBulletItem
        Planned to use agile methodologies to improve student registration and exam season productivity.
        \SubBulletItem
        Developed the required APIs for E-Learning Management System (\href{https://ems.iranian.ac.ir/?lang=en}{EMS}) for managing and accessing students and professors for their unit registration, grades, and payments.
        \SubBulletItem
        Enhanced the performance of server response time for EMS by optimizing the database and configuring caching.
    \end{Detail}
    ...
    {\textbf{Mate Machine}},
    {\small{Remote\,\SubBulletSymbol\,Part-time}}
    \hfill
    ...
    \begin{Detail}
        \SubBulletItem
        Refactored to Flutter's best architecture design for the current requirements.
        \SubBulletItem
        Implemented SignalR socket client and full-featured social media chat.
        \SubBulletItem
        Used most of Firebase services like Cloud Messaging, Analytics and Crashlytics.
        \SubBulletItem
        Implemented P2P WebRTC video chatting.
    \end{Detail}
    ...
    \begin{Detail}
        \SubBulletItem
        Researched Flutter framework as the migration framework for the android application.
        \SubBulletItem
        Developed requirement APIs for the application in Drupal.
        \SubBulletItem
        Created and developed the required plugins for the application media notification in native android.
        \SubBulletItem
        Developed features like downloadable multimedia content, live score matches, and social media profiles.
        \SubBulletItem
        Implemented TV Sports matches streaming with Live Chat on the SocketIO.
        \SubBulletItem
        Used Firebase services like Notifications, Analytics, and Crashlytics.
        \SubBulletItem
        Reached more than 200k active users with less than 0.3\% crashes on the Google Play Store and the local stores.
    \end{Detail}
    ...
    \Item
    Community Organizer and Speaker for flutter Montreal
    ...
    \BulletItem
    French: Limited working proficiency (Level 4/7 from Quebec Government)
    ...
    \,\SubBulletSymbol\,
    \href{tel:+2349065266070}
    {+23\,(906)\,526-6070}

    \BigGap
    \BulletItem
    \href{https://linkedin.com/in/srasoulzadeh}
    {\textbf{Dr. Shervin Rasoulzadeh}}
    \newline
